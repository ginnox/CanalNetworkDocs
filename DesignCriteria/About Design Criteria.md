...
The user can also introduce fictious controls for design purposes. This could be to change the hydraulic characterisics or the construciotn details of a canal reach. The user can manually insert such nodes, and edit their position to suit the design purpose. Such control is shown also in the profile view, with the red arrow.
...
This is the last group of parameters.
